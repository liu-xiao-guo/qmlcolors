...
UBUNTU_TRANSLATION_DOMAIN="qmlcolors.liu-xiao-guo"
...
aptest.commands = bash $$PWD/qmlcolors/tests/autopilot/run
aptest.depends  = sub-qmlcolors

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/qmlcolors/tests/unit
unittest.depends  = sub-qmlcolors
